...
3. **Drop in `tokens.css`** and add the Google Fonts:
   ...
   <link
   	rel="stylesheet"
   	href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,400&family=EB+Garamond:ital,wght@0,400;1,400&family=IBM+Plex+Mono:wght@300;400;500&display=swap"
   />
   ```
